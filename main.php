...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Aplikasi Stok Gudang</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="description" content="Aplikasi Stok Gudang">
    <meta name="author" content="Alatif Rizki" />
    
    <!-- favicon -->
    <link rel="shortcut icon" href="assets/img/gni2.png" />
  ...
  <body class="skin-blue fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
		...
		<img src="assets/img/logo1.png" alt="Logo"></image>
        </a>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2023 - <a href="#">Alatif Rizki, A.md.Kom MOS</a></strong>
      </footer>
    </div><!-- ./wrapper -->
