...
<section class="content-header">
  <h1>
    ...
    <a class="btn btn-primary btn-social pull-right" href="?module=form_it_keluar&form=add" title="Tambah Data" data-toggle="tooltip">
...
<section class="content">
  <div class="row">
    ...
    // jika alert = 1
    // tampilkan pesan Sukses "Data IT Masuk berhasil disimpan"
    elseif ($_GET['alert'] == 1) {
      echo "<div class='alert alert-success alert-dismissable'>
              <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
              <h4>  <i class='icon fa fa-check-circle'></i> Sukses!</h4>
              Data IT Keluar berhasil disimpan.
            </div>";
    }
    ?>
        ...
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.kode_transaksi,a.tanggal_keluar,a.kode_helm,a.jumlah_keluar,b.kode_helm,b.nama_helm,b.satuan
                                            FROM is_it_keluar as a INNER JOIN is_it as b ON a.kode_helm=b.kode_helm ORDER BY kode_transaksi DESC")
