...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO is_it_masuk(kode_transaksi,tanggal_masuk,kode_helm,jumlah_masuk,created_user) 
            ...
            if ($query) {
                ...
                if ($query1) {                       
                    ...
                    header("location: ../../main.php?module=it_masuk&alert=1");
                }
            }   
        }   
    }
