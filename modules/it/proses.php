...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            // perintah query untuk menyimpan data ke tabel it
            $query = mysqli_query($mysqli, "INSERT INTO is_it(kode_helm,nama_helm,harga_beli,harga_jual,satuan,created_user,updated_user) 
            ...
            if ($query) {
                ...
                header("location: ../../main.php?module=it&alert=1");
            }   
        }   
    }
    ...
    elseif ($_GET['act']=='update') {
        if (isset($_POST['simpan'])) {
            if (isset($_POST['kode_helm'])) {
                ...
                $query = mysqli_query($mysqli, "UPDATE is_it SET  nama_helm       = '$nama_helm',
                ...
                if ($query) {
                    ...
                    header("location: ../../main.php?module=it&alert=2");
                }         
            }
        }
    }
    ...
    elseif ($_GET['act']=='delete') {
        if (isset($_GET['id'])) {
            ...
            // perintah query untuk menghapus data pada tabel helm
            $query = mysqli_query($mysqli, "DELETE FROM is_it WHERE kode_helm='$kode_helm'")
                                            or die('Ada kesalahan pada query delete : '.mysqli_error($mysqli));

            // cek hasil query
            if ($query) {
                // jika berhasil tampilkan pesan berhasil delete data
                header("location: ../../main.php?module=it&alert=3");
            }
        }
    }       
}       
