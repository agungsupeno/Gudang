...
<section class="content-header">
  <h1>
    <i class="fa fa-file-text-o icon-title"></i> Laporan Data Barang IT Masuk
  </h1>
  <ol class="breadcrumb">
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <!-- form start -->
        <form role="form" class="form-horizontal" method="GET" action="modules/lap-it-masuk/cetak.php" target="_blank">
          <div class="box-body">
