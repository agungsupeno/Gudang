...
if (isset($_GET['tgl_awal'])) {
    $no    = 1;
    // fungsi query untuk menampilkan data dari tabel Tools keluar
    $query = mysqli_query($mysqli, "SELECT a.kode_transaksi,a.tanggal_keluar,a.kode_helm,a.jumlah_keluar,b.kode_helm,b.nama_helm,b.satuan
                                    FROM is_tools_keluar as a INNER JOIN is_tools as b ON a.kode_helm=b.kode_helm
...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- Bagian halaman HTML yang akan konvert -->
    <head>
        ...
        <title>gni (lap-tools-keluar)</title>
        <link rel="stylesheet" type="text/css" href="../../assets/css/laporan.css" />
    </head>
    <body>
        <div id="title">
            LAPORAN DATA TOOLS KELUAR 
        </div>
    <?php  
            ...
            <table width="100%" border="0.3" cellpadding="0" cellspacing="0">
                <thead style="background:#e8ecee">
                    <tr class="tr-title">
                        ...
                        <th height="20" align="center" valign="middle">KODE TOOLS</th>
                        <th height="20" align="center" valign="middle">NAMA TOOLS</th>
...
?>	
            ...
            <div id="footer-tanggal">
                Bekasi, <?php echo tgl_eng_to_ind("$hari_ini"); ?>
            </div>
