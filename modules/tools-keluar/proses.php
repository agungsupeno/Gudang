...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            // perintah query untuk menyimpan data ke tabel tools masuk
            $query = mysqli_query($mysqli, "INSERT INTO is_tools_keluar(kode_transaksi,tanggal_keluar,kode_helm,jumlah_keluar,created_user) 
            ...
            if ($query) {
                ...
                $query1 = mysqli_query($mysqli, "UPDATE is_tools SET stok        = '$total_stok'
                ...
                if ($query1) {                       
                    ...
                    header("location: ../../main.php?module=tools_keluar&alert=1");
                }
            }   
        }   
    }
