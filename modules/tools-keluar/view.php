...
<section class="content-header">
  <h1>
    <i class="fa fa-sign-out icon-title"></i> Data Tools Keluar

    <a class="btn btn-primary btn-social pull-right" href="?module=form_tools_keluar&form=add" title="Tambah Data" data-toggle="tooltip">
  ...
  <div class="row">
    ...
    elseif ($_GET['alert'] == 1) {
      echo "<div class='alert alert-success alert-dismissable'>
              ...
              Data Tools Keluar berhasil disimpan.
            </div>";
    }
    ?>
        ...
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT a.kode_transaksi,a.tanggal_keluar,a.kode_helm,a.jumlah_keluar,b.kode_helm,b.nama_helm,b.satuan
                                            FROM is_tools_keluar as a INNER JOIN is_tools as b ON a.kode_helm=b.kode_helm ORDER BY kode_transaksi DESC")
