...
// jika user sudah login, maka jalankan perintah untuk insert, update, dan delete
    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            ...
            $query = mysqli_query($mysqli, "INSERT INTO is_tools(kode_helm,nama_helm,harga_beli,harga_jual,satuan,created_user,updated_user) 
            ...
            if ($query) {
                ...
                header("location: ../../main.php?module=tools&alert=1");
            }   
        }   
    }
    ...
    elseif ($_GET['act']=='update') {
        if (isset($_POST['simpan'])) {
            if (isset($_POST['kode_helm'])) {
                ...
                // perintah query untuk mengubah data pada tabel tools
                $query = mysqli_query($mysqli, "UPDATE is_tools SET  nama_helm       = '$nama_helm',
                ...
                if ($query) {
                    ...
                    header("location: ../../main.php?module=tools&alert=2");
                }         
            }
        }
    }
    ...
    elseif ($_GET['act']=='delete') {
        if (isset($_GET['id'])) {
            ...
            // perintah query untuk menghapus data pada tabel tools
            $query = mysqli_query($mysqli, "DELETE FROM is_tools WHERE kode_helm='$kode_helm'")
                                            or die('Ada kesalahan pada query delete : '.mysqli_error($mysqli));

            // cek hasil query
            if ($query) {
                // jika berhasil tampilkan pesan berhasil delete data
                header("location: ../../main.php?module=tools&alert=3");
            }
        }
    }       
}       
